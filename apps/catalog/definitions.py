        ...
        'sections': {
            ...
            'measurements': [
                ...
                *grouped('Body Measurements',
                    ...
                    measurement('underbust', 'Underbust'),
                    measurement('high_waist', 'High Waist'),
                    measurement('front_shoulder', 'Front Shoulder'),
                    measurement('back_shoulder', 'Back Shoulder'),
                    ...
                    measurement('bicep_length', 'Bicep Length'),
                    measurement('bicep_round', 'Bicep Round'),
                    measurement('elbow', 'Elbow'),
                    measurement('elbow_length', 'Elbow Length'),
                    measurement('elbow_round', 'Elbow Round'),
                    measurement('wrist', 'Wrist'),
                    measurement('full_sleeves_round', 'Full Sleeves Round'),
    ...
    },
    {
        ...
        'sections': {
            ...
            'measurements': [
                ...
                *grouped('Body',
                    measurement('lehenga_length', 'Lehenga Length'),
                    measurement('lehenga_waist', 'Lehenga Waist'),
    ...
    },
    {
        ...
        'sections': {
            ...
            'measurements': [
                ...
                measurement('knee_length', 'Knee Length'),
                measurement('calf', 'Calf'),
                measurement('ankle', 'Ankle'),
                measurement('ankle_length', 'Ankle Length'),
                measurement('ankle_round', 'Ankle Round'),
                measurement('crotch', 'Crotch'),
                measurement('crotch_length', 'Crotch Length'),
                measurement('pant_waist', 'Pant Waist'),
